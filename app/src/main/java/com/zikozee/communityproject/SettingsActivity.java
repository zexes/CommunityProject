...
import com.zikozee.communityproject.utility.FilePaths;
    ...
    private void init(){
        ...
        mSave.setOnClickListener(v -> {
            ...
            if(!mName.getText().toString().equals("")){
                reference.child(getString(R.string.dbnode_transport_users))
        ...
        mResetPasswordLink.setOnClickListener(v -> {
                    ...
                    taskSnapshot.getMetadata().getReference().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            FirebaseDatabase.getInstance().getReference()
                                    .child(getString(R.string.dbnode_transport_users))
                                    .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
...
//                        Toast.makeText(SettingsActivity.this, progress + "%", Toast.LENGTH_SHORT).show();
    ...
    private void getUserAccountData(){
        ...
        /*
            ---------- QUERY Method 1 ----------
         */
        Query query1 = reference.child(getString(R.string.dbnode_transport_users))
                .orderByKey()
